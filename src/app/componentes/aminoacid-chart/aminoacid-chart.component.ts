...
@Component({
  selector: 'app-aminoacid-chart',
  templateUrl: './aminoacid-chart.component.html',
  styleUrls: ['./aminoacid-chart.component.scss'],
})
export class AminoacidChartComponent implements OnInit {
